...
function Navbar() {
  ...
  return (
    <div className="w-full bg-white  gap-10 items-center  sticky top-0 z-10 shadow-lg">
      <div className="flex justify-between">
        <Link
          to={"/"}
          className="flex justify-center items-center lg:px-10 px-3 py-3"
        >
          <div className="lg:w-16 lg:h-16 w-10 h-10 rounded-full overflow-hidden">
            <img
              className="w-full h-full"
              src="https://i.ibb.co/C8sv2s1/profile-pic.png"
            />
          </div>
          <h1 className="uppercase lg:text-xl text-lg font-bold text-gray-800 opacity-90 tracking-wide hover:text-purple-600 cursor-pointer">
            SUVAM
          </h1>
        </Link>

        <div className="lg:w-6/12 w-auto flex items-center lg:mr-16 mr-5">
          <div className="block lg:hidden">
            <MenuIcon status={status} toggleStatus={toggleStatus} />
          </div>

          <div className=" justify-evenly  w-full items-center    uppercase font-semibold  hidden lg:flex ">
      ...
      <div className="relative ">
        <div
          className={`flex-col items-center text-2xl gap-6 py-5 juce uppercase font-semibold absolute   lg:hidden flex ${
            status ? " block" : " hidden"
...
function MenuIcon({
  ...
  return (
    <div className="relative cursor-pointer" onClick={toggleStatus}>
      {status && status ? (
        <div className=" flex  flex-col lg:mr-10 mr-8 gap-0 relative duration-200">
